...
extern void good_move( int move, board_t *board, int depth, int height, int ThreadId );
extern void history_good( int move, board_t *board, int ThreadId );
extern void history_bad( int move, board_t *board, int ThreadId );
extern void history_reset( int move, board_t *board, int ThreadId );
extern void note_moves( list_t *list, board_t *board, int height, int trans_killer, int ThreadId );
