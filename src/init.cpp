...
int MobAttack = 1;
int MobDefense = 0;
int KnightMobOpening = 12;
int KnightMobEndgame = 6;
int CannonMobOpening = 3;
int CannonMobEndgame = 1;
int BishopMobOpening = 1;
int BishopMobEndgame = 1;
int RookMobOpening = 6;
int RookMobEndgame = 6;

int KingMobOpening = 0;
int KingMobEndgame = 0;
int PawnMobOpening = 15;
int PawnMobEndgame = 15;
int AdvisorMobOpening = 1;
int AdvisorMobEndgame = 1;

// pawn
int PawnStructureWeightOpening = 32;
int PawnStructureWeightEndgame = 64;
...
int BlockedBishop = 20;

// pattern
int BlockedKnight = 20;
int DoubleProtKnight = 10;
int DoubleEdgeKnight = 50;
int EmptyHeadCannon = 50;
int BasidiumCannon = 20;
...
int AttackerDistance = 10;
int DefenderDistance = 20;
bool UseKingAttack = true;
int KingAttackOpening = 10;
...
int CannonEndgame = 500;
int BishopOpening = 250;
int BishopEndgame = 250;
int AdvisorOpening= 250;
int AdvisorEndgame= 250;
int RookOpening = 1200;
int RookEndgame = 1200;

int BishopPairOpening = 50;
int BishopPairEndgame = 50;
int OpeningExchangePenalty = 30;
int EndgameExchangePenalty = 30;
bool UseMaterialImbalance = true;
int MaterialImbalanceWeightOpening = 256;
int MaterialImbalanceWeightEndgame = 256;

// pst
int PieceSquareWeightOpening = 64;
int PieceSquareWeightEndgame = 16;
...
void gen_default_ini_file( char *file_name )
    ...
    printf("writing default CGChess.cfg...\n");
    FILE *fp;
    fp = fopen("CGChess.cfg", "w");
    fprintf(fp, "// CGChess default parameters file\n");
    fprintf(fp, "\n");
...
void gen_random_ini_file( char *file_name )
    {
    printf("writing random CGChess.cfg...\n");
    FILE *fp;
    fp = fopen("CGChess.cfg", "w");
    fprintf(fp, "// CGChess random parameters file\n");
    fprintf(fp, "\n");
    fprintf(fp, "// lazy eval\n");
    fprintf(fp, "LazyEval %d\n", get_rand_num(0, 1));
