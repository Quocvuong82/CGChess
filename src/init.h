...
extern int CannonMobOpening;
extern int CannonMobEndgame;
extern int CannonUnit;
extern int PawnMobOpening;
extern int PawnMobEndgame;
extern int PawnUnit;
extern int AdvisorUnit;
extern int AdvisorMobOpening;
extern int AdvisorMobEndgame;
...
extern int BlockedKnight;
extern int DoubleEdgeKnight;
extern int DoubleProtKnight;//连环马
extern int EmptyHeadCannon;
extern int BasidiumCannon;//担子炮
//extern int BlockedBishop;//象眼
extern int StuffyCannon;
extern int HeartKnight;//窝心马
...
extern int CannonOpening;
extern int CannonEndgame;
extern int AdvisorOpening;
extern int AdvisorEndgame;
